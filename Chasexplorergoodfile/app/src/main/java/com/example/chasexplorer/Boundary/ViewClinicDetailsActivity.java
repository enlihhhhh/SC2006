...
public class ViewClinicDetailsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final Clinic clinicDetails = new Gson()
    .fromJson(jsonMyObject, Clinic.class);
    ...
    mRatingBar.setRating(
      reviewAdapter.getAvgRatingForClinic(clinicDetails.getClinicCode())
    );
    ...
    mRatingAmt.setText(
      "Ratings: " +
      reviewAdapter.getNumberOfFeedbackForClinic(clinicDetails.getClinicCode())
    );
    ...
    final String clinicContact = clinicDetails.getClinicTelNo();
      ...
      new View.OnClickListener() {
        ...
        public void onClick(View r) {
          if (getCallPermission()) {
            ...
            callIntent.setData(Uri.parse("tel:" + clinicContact));
        ...
        public void onClick(View r) {
          ...
          builder
            ...
            .appendQueryParameter(
              "destination",
              clinicDetails.getXCoordinate() +
              "," +
              clinicDetails.getYCoordinate()
            );
        ...
        public void onClick(View r) {
          if (firebase.getInstance().getCurrentUser() != null) {
            ...
            i.putExtra(
              "index",
              String.valueOf(
                ClinicAdapter.getIndexOfUnsortedClinicAL(clinicDetails)
              )
            );
    ...
    clinicStatusBox.setOnClickListener(
      new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          ...
          View popupView = inflater.inflate(
            R.layout.clinic_opening_hours,
            null
          );

          TextView mondayTimings = (TextView) popupView.findViewById(
            R.id.mondayTimingsTxt
          );
          TextView tuesdayTimings = (TextView) popupView.findViewById(
            R.id.tuesdayTimingsTxt
          );
          TextView wednesdayTimings = (TextView) popupView.findViewById(
            R.id.wednesdayTimingsTxt
          );
          TextView thursdayTimings = (TextView) popupView.findViewById(
            R.id.thursdayTimingsTxt
          );
          TextView fridayTimings = (TextView) popupView.findViewById(
            R.id.fridayTimingsTxt
          );
          TextView saturdayTimings = (TextView) popupView.findViewById(
            R.id.saturdayTimingsTxt
          );
          TextView sundayTimings = (TextView) popupView.findViewById(
            R.id.sundayTimingsTxt
          );
  ...
  public void onResume() {
    ...
    mRatingAmt.setText(
      "(" + reviewAdapter.getNumberOfFeedbackForClinic(clinicCode) + ")"
    );
          ...
          if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            Toast
              .makeText(
                ...
                "User granted call permission! Click call again to call the clinic",
                Toast.LENGTH_SHORT
              )
              .show();
            ...
            Toast
              .makeText(
                getApplicationContext(),
                "User did not grant call permission!",
                Toast.LENGTH_SHORT
              )
              .show();
          }
  ...
  private boolean getCallPermission() {
    if (
      ...
      ActivityCompat.requestPermissions(
        ViewClinicDetailsActivity.this,
  ...
  private void getOperatingHours() {
    ...
    final RequestQueue mRequestQueue = Volley.newRequestQueue(
      getApplicationContext()
    );
    ...
    final StringRequest stringRequest = new StringRequest(
      ...
      response -> {
        try {
          ...
          if (candidates.length() > 0) placeID =
            candidates.getJSONObject(0).getString("place_id").toString();
          ...
          if (!placeID.equals("")) {
            ...
            final StringRequest stringRequest2 = new StringRequest(
              Request.Method.GET,
              url1,
              response1 -> {
                Gson gson = new Gson();
                PlaceDetails placeDetails = gson.fromJson(
                  response1,
                  PlaceDetails.class
                );
                ...
                try {
                  ...
                  clinicSchedule.addAll(
                    placeDetails.getResult().getOpeningHours().getWeekdayText()
                  );
                  ...
                  if (placeDetails.getResult().getOpeningHours().getOpenNow()) {
                    ...
                    clinicStatusBox.setBackgroundResource(
  ...
  private int getDayOfTheWeek() {
    ...
    if (today == 1) return 6; else return today - 2;
  }
}
